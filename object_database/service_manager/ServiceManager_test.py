...
class ServiceManagerTest(ServiceManagerTestCommon, unittest.TestCase):
    ...
    def test_delete_service(self):
        ...
        with self.database.transaction():
            ServiceManager.createOrUpdateService(SimpleTestService, "SimpleTestService", target_count=1)
    ...
    def test_remove_service(self):
        ...
        with self.database.transaction():
            ServiceManager.createOrUpdateService(SimpleTestService, "SimpleTestService", target_count=2)
        ...
        timeout = 6.0 * self.ENVIRONMENT_WAIT_MULTIPLIER
        self.assertTrue(
            ServiceManager.waitStopped(self.database, "SimpleTestService", timeout), serviceState()
        )
